...
var GEOMETRIES = {
    ...
    text: function(params) {
        ...
        var g = new THREE.TextGeometry(params.name || " ", {font: "droid sans mono", height: 6, size: size, style: "normal"});
...
var define = scope.addNode("define");
define.addArg(null, 'add');
define.addArg();

lambda.addArg();
lambda.addArg();
lambda.addOutput();
define.setPosition(-25, -50, 0);

scope.addEdge(lambda.children.output[0], define.args[1]);
