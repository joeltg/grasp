...
var File = (function () {
  ...
  File.prototype.normaliseOptions = function normaliseOptions(opts) {
    opts = this.opts = (0, _options.normaliseOptions)((0, _lodashObjectAssign2["default"])({}, opts));
    ...
    if (opts.filename) {
      ...
      opts = (0, _optionsResolveRc2["default"])(rcFilename, opts);
    }
    ...
    if (opts.env) (0, _helpersMerge2["default"])(opts, (0, _options.normaliseOptions)(opts.env[envKey]));
    ...
    for (var key in File.options) {
      ...
      // default
      if (val == null) val = (0, _lodashLangClone2["default"])(option["default"]);

      // validate
      if (val) val = (0, _options.validateOption)(key, val, this.pipeline);
