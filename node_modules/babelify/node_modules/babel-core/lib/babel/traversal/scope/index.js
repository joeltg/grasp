...
var Scope = (function () {
  ...
  Scope.prototype.hasBinding = function hasBinding(name, noGlobals) {
    ...
    if (!noGlobals && (0, _lodashCollectionIncludes2["default"])(Scope.globals, name)) return true;
    if (!noGlobals && (0, _lodashCollectionIncludes2["default"])(Scope.contextVariables, name)) return true;
    return false;
  };
